...
public class WaveFunction : MonoBehaviour
{
    ...
    void InitializeGrid()
    {
        for (int z = 0; z < dimensions; z++)
        {
            ...
            {
                Cell newCell = Instantiate(cellObj, new Vector3(x * 2, 0, z * 2), Quaternion.identity);
    ...
    void CollapseCell(List<Cell> tempGrid)
    {
        ...
        Tile foundTile = cellToCollapse.tileOptions[UnityEngine.Random.Range(0, cellToCollapse.tileOptions.Length)];
